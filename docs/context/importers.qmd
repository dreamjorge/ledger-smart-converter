...
4. Build `normalized_description` via `normalize_description(...)` (`src/description_normalizer.py`)
5. Validate transactions
6. Resolve canonical account id (`config/accounts.yml`) for each canonical transaction
