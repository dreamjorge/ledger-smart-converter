...
2. **Parser Factory**: Instantiates the correct parser based on bank config (`ParserFactory`).
...
2. `ParserFactory` instantiates the correct parser (`XmlParser`, `ExcelParser`, or `PdfParser`).
