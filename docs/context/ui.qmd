...
- Bank selection from the sidebar so controls remain visible across all pages
...
# Sidebar controls stay outside page wrappers
...
**Bank/language controls** live in the sidebar so they persist consistently across Import, Analytics, Manual Entry, and Settings.
