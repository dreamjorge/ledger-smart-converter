...
├── test_common_utils.py            # 2 tests - Utility functions
├── test_data_service.py            # 11 tests - CSV loading
├── test_generic_importer.py        # 1 test - Import determinism
├── test_healthcheck.py             # 1 test - Dependency validation
├── test_import_service.py          # 2 tests - Import workflow
├── test_rule_service.py            # 2 tests - Rule staging/merging
