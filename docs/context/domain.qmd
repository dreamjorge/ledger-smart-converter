...
class CanonicalTransaction:
    ...
    description: str       # Legacy description field (compatibility)
    raw_description: str   # Original parsed source text
    normalized_description: str  # Deterministic normalized text for categorization
    amount: float          # Transaction amount
    bank_id: str          # e.g., "santander_likeu", "hsbc"
    account_id: str       # Account identifier
    canonical_account_id: str  # Canonical account id, e.g. "cc:santander_likeu"
    source: str = "data"  # Data source type
    rfc: str = ""         # Mexican tax ID (optional)

    @property
    def id(self) -> str:  # Hash prefers normalized_description when present
```
...
**Canonical Account ID**: Required, non-empty (`cc:<bank_id>` fallback when unmapped)
...
txn = CanonicalTransaction(
    date="2024-01-15",
    description="OXXO STORE",  # legacy compatibility field
    raw_description="OXXO STORE 12345",
    normalized_description="Oxxo Store",
    amount=125.50,
...
- **Hashed**: ID generated from key fields for deduplication, preferring `normalized_description`
...
1. `codegraph_impact "CanonicalTransaction"` → see affected importers/services
