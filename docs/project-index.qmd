...
tests/                     # pytest suite (558 collected; 550 fast + 8 slow)
```
...
**Completed**: Validation layer, service architecture, safe rules workflow, SQLite persistence, account mapping, DB pipeline, normalized-description categorization, DB-backed analytics, Firefly export service, audit events
